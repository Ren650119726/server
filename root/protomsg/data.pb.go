...
func (Card_CARDCOLOR) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{5, 0} }
...
func (*AccountStorageData) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*AccountGameData) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*Email) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*GameInfo) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*Card) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func init() { proto.RegisterFile("protobuf/data.proto", fileDescriptor1) }
