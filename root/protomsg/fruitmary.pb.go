...
func (FRUITMARYMSG) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (Fruit1ID) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (Fruit2ID) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*ENTER_GAME_FRUITMARY_REQ) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*ENTER_GAME_FRUITMARY_RES) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*LEAVE_GAME_FRUITMARY_REQ) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*LEAVE_GAME_FRUITMARY_RES) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
...
func (*START_MARY_REQ) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{4} }
...
func (*START_MARY_RES) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{5} }
...
func (*FRUITMARYPosition) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{6} }
...
func (*FRUITMARY_Result) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{7} }
...
func (*UPDATE_MARY_BONUS) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{8} }
...
func (*START_MARY2_REQ) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{9} }
...
func (*START_MARY2_RES) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{10} }
...
func (*Mary2_Result) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{11} }
...
func (*NEXT_MARY_RESULT) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{12} }
...
func (*PLAYERS_LIST_RES) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{13} }
...
func init() { proto.RegisterFile("protobuf/fruitmary.proto", fileDescriptor3) }
