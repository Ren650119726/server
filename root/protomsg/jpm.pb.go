...
func (JPMMSG) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (JPMID) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*ENTER_GAME_JPM_REQ) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*ENTER_GAME_JPM_RES) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*LEAVE_GAME_JPM_REQ) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (*LEAVE_GAME_JPM_RES) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func (*START_JPM_REQ) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{4} }
...
func (*START_JPM_RES) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{5} }
...
func (*JPMPosition) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{6} }
...
func (*JPM_Result) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{7} }
...
func (*UPDATE_JPM_BONUS) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{8} }
...
func (*PLAYERS_JPM_LIST_RES) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{9} }
...
func init() { proto.RegisterFile("protobuf/jpm.proto", fileDescriptor6) }
