...
// 大厅发送的玩家数据
func (self *S777) SERVERMSG_HG_PLAYER_DATA_REQ(actor int32, msg []byte, session int64) {
...
// 玩家请求进入小玛利房间
func (self *S777) S777MSG_CS_ENTER_GAME_S777_REQ(actor int32, data []byte, session int64) int32 {
	enterPB := packet.PBUnmarshal(data, &protomsg.ENTER_GAME_S777_REQ{}).(*protomsg.ENTER_GAME_S777_REQ)
