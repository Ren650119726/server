...
func asyn_addMoney(trycount int, addr_url, unique string, num int64, roomID int32, desc string, back func(backunique string, backmoney int64, bwType int32), errback func()) { // dfdc
	if trycount == 0 {
		return
	}
	go func() {
