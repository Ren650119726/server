...
func (self *Room) Init(actor *core.Actor) bool {
	...
	self.owner.AddTimer(utils.MILLISECONDS_OF_SECOND*1, -1, self.updateRobot)
...
func (self *Room) enterRoom(accountId uint32) {
	...
	// 通知大厅 玩家进入房间
	send_tools.Send2Hall(inner.SERVERMSG_GH_PLAYER_ENTER_ROOM.UInt16(), &inner.PLAYER_ENTER_ROOM{ // fruitMary
