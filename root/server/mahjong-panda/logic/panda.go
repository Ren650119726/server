...
func (self *PANDA) Init(actor *core.Actor) bool {
	// 先处理脚本
	if core.ScriptDir != "" {
...
func (self *PANDA) Stop() {

}

func (self *PANDA) HandleMessage(actor int32, msg []byte, session int64) bool {
	...
	case protomsg.MSGID_HG_REENTER_OTHER_GAME.UInt16(): // 修改玩家信息
