...
func (l *Logger) Debug(args ...interface{}) {
	if l.level >= LevelDebug {
		l.Output(depth+l.dp, "Debug:"+fmt.Sprint(args...))
	}
}
...
func (l *Logger) Info(args ...interface{}) {
	if l.level >= LevelInfo {
		l.Output(depth+l.dp, "Info:"+fmt.Sprint(args...))
	}
}
...
func (l *Logger) Warn(args ...interface{}) {
	if l.level >= LevelWarn {
		l.Output(depth+l.dp, "Warn:"+fmt.Sprint(args...))
	}
}
...
func (l *Logger) Error(args ...interface{}) {
	if l.level >= LevelError {
		l.Output(depth+l.dp, "Error:"+fmt.Sprintln(args...)+Backtrace(depth+l.dp))
	}
}
...
func (l *Logger) Panic(args ...interface{}) {
	if l.level >= LevelPanic {
		l.Output(depth+l.dp, "Error:"+fmt.Sprint(args...))
	}
}
...
func (l *Logger) Debugf(format string, args ...interface{}) {
	if l.level >= LevelDebug {
		l.Output(depth+l.dp, "Debug:"+fmt.Sprintf(format, args...))
	}
}
...
func (l *Logger) Infof(format string, args ...interface{}) {
	if l.level >= LevelInfo {
		l.Output(depth+l.dp, "Info:"+fmt.Sprintf(format, args...))
	}
}
...
func (l *Logger) Warnf(format string, args ...interface{}) {
	if l.level >= LevelWarn {
		l.Output(depth+l.dp, "Warn:"+fmt.Sprintf(format, args...))
	}
}
...
func (l *Logger) Errorf(format string, args ...interface{}) {
	if l.level >= LevelError {
		l.Output(depth+l.dp, "Error:"+fmt.Sprintf(format+"\n", args...)+Backtrace(depth+l.dp))
	}
}
...
func (l *Logger) Panicf(format string, args ...interface{}) {
	if l.level >= LevelPanic {
		l.Output(depth+l.dp, "Panic:"+fmt.Sprintf(format, args...)+Backtrace(depth+l.dp))
	}
}
...
func (l *Logger) Fatalf(format string, args ...interface{}) {
	if l.level >= LevelFatal {
		l.Output(depth+l.dp, "Error:"+fmt.Sprintf(format, args...))
	}
}
