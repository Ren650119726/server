...
func (self *DEH) Init(actor *core.Actor) bool {
	// 先处理脚本
	if core.ScriptDir != "" {
...
func (self *DEH) HandleMessage(actor int32, msg []byte, session int64) bool {
	...
	case protomsg.Old_MSGID_UPDATE_CHARGE.UInt16(): // 大厅通知更新金额
		self.Old_MSGID_UPDATE_CHARGE(actor, msg, session)
